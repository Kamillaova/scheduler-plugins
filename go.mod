...
require (
	...
	github.com/kubernetes-sigs/dra-driver-cpu/api v0.0.0-20260910123321-54ee4ee6468a
...
replace github.com/kubernetes-sigs/dra-driver-cpu/api => github.com/Kamillaova/dra-driver-cpu/api v0.0.0-20260910123321-54ee4ee6468a
